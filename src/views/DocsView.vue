  ...
  <dialog ref="edit" id="edit" class="modal">
    <div class="modal-box flex flex-col">
      ...
      <form @submit.prevent="editData" class="flex flex-col">
        <TextInput label="Título" placeholder="Introducir" @input="updateTitle" :key="refresh" :read="data.title" />
        <TextInput label="Descripción" placeholder="Introducir" @input="updateDescription" :key="refresh" :read="data.description" />
